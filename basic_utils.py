...
from infodiffusion import gaussian_diffusion as gd
from infodiffusion.gaussian_diffusion import SpacedDiffusion, space_timesteps
from infodiffusion.transformer_model import TransformerNetModel
...
def load_defaults_config():
    ...
    """
    with open('infodiffusion/config.json', 'r') as f:
        return json.load(f)

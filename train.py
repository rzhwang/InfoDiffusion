...
import numpy as np
from infodiffusion.utils import dist_util, logger
from infodiffusion.text_datasets import load_data_text
from infodiffusion.step_sample import create_named_schedule_sampler
...
def main():
    ...
    if ('LOCAL_RANK' not in os.environ) or (int(os.environ['LOCAL_RANK']) == 0):
        wandb.init(
            project=os.getenv("WANDB_PROJECT", "infodiffusion"),
